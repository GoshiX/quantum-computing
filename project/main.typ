...
$ H_C_7 = B sum_(S in PP(T) 2 <= |S| <= |T|) (sum_(k in K)sum_(i, j in S)x_(i j k) \ + sum_(l=0)^(ceil.l 1 + log_2 (|S| - 1) ceil.r) 2^l lambda_(l S) - |S|+1) "" ^2 $

$ H_C_8 = B sum_(k in K) (sum_(i in T)sum_(j in T)q_i x_(i j k) + sum_(i in T)q_i n_(i k) \ + sum_(l=0)^(ceil.l 1+log_2 Q_k ceil.r) 2^l lambda_(l k) - Q_k) "" ^2 $

$ H_C_9 = B sum_(d in D) (sum_(k in K)y_(k d)(sum_(i in T)sum_(j in T)q_i x_(i j k) + sum_(i in T)q_i n_(i k)) \ + sum_(l=0)^(ceil.l 1+log_2 V_d ceil.r) 2^l lambda_(l d) - V_d) "" ^2 $
